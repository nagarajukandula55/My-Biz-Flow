...
export const scSymptomCodeRows: Row[] = [
  {
    ...
    category: "Power",
    deviceCategoryScope: ["Mobile Phones", "Laptops", "Television"],
    parentId: "",
    isActive: "Active",
  ...
  },
  {
    ...
    category: "Mechanical",
    deviceCategoryScope: ["Washing Machine", "Refrigerator", "Air Conditioner"],
    parentId: "",
    isActive: "Active",
    moduleSlug: "service-centre",
  },
  {
    ...
    category: "Display",
    deviceCategoryScope: ["Laptops", "Monitors", "Television"],
    parentId: "",
    isActive: "Active",
    moduleSlug: "service-centre",
  },
