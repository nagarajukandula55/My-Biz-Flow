...
import { PLAN_TIERS, type PlanTier } from "@/lib/designer/partnerTypesData";

const TIER_LABEL: Record<PlanTier, string> = { basic: "Basic", pro: "Pro", ultimate: "Ultimate" };

/**
 * A Partner Type's own module set AND its own Basic/Pro/Ultimate page
 ...
 * shared/global tier list: every Partner Type proposes its own three tiers
  ...
  return (
    <div>
      ...
      <p className="mb-3 text-xs text-text-muted">
        ...
        pages for this Partner Type specifically.
      </p>
