...
import { createPartnerTypeAction } from "../actions";

export const dynamic = "force-dynamic";

registerPage({
  id: "platform.partner-types.create",
  moduleSlug: "platform",
  title: "Partner Types — Create",
  path: "/admin/partner-types/new",
  kind: "form",
  superAdminOnly: true,
  customizableRegions: [{ key: "form-fields", label: "Form fields" }],
  explanation:
    "Creation form for a new Partner Type — default modules, its own Basic/Pro/Ultimate page-tier breakdown, and assignable Roles. Writes to the PartnerType Prisma table.",
  sourceFile: "src/app/admin/(protected)/partner-types/new/page.tsx",
});

export default async function NewPartnerTypePage() {
    ...
    <SuperAdminGate>
      <div className="mbf-page">
        <div className="border-b border-border bg-bg-raised px-6 py-4">
          <h1 className="font-display text-lg font-bold text-text">New Partner Type</h1>
        </div>
        <div className="p-6">
          <form action={createPartnerTypeAction}>
