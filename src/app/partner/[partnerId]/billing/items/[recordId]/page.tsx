...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/items/[recordId]",
  kind: "detail",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/items/[recordId]/page.tsx",
});
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href={`/partner/${params.partnerId}/billing/items`} className="btn-outline">
                  &larr; Back
                </Link>
                <Link href={`/partner/${params.partnerId}/billing/items/${params.recordId}/edit`} className="btn-outline">
                  Edit
                </Link>
