...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/items/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/items/[recordId]/edit/page.tsx",
});

export default async function EditBillingItemPage({ params }: { params: { partnerId: string; recordId: string } }) {
  const record = await getBusinessRecord(params.partnerId, "billing-items", params.recordId);
  if (!record) notFound();
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={updateBusinessRecordAction.bind(null, params.partnerId, "billing-items", params.recordId)}
          />
        </div>
      </div>
    </AppShell>
