...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/items/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/items/new/page.tsx",
});

export default async function NewBillingItemPage({ params }: { params: { partnerId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "billing-items")}
          />
        </div>
      </div>
    </AppShell>
