...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/recurring/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/recurring/[recordId]/edit/page.tsx",
});

export default async function EditRecurringInvoicePage({ params }: { params: { partnerId: string; recordId: string } }) {
