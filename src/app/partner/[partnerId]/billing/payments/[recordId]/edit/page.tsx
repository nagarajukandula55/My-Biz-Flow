...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/payments/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/payments/[recordId]/edit/page.tsx",
});

export default async function EditBillingPaymentPage({ params }: { params: { partnerId: string; recordId: string } }) {
