...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/payments/[recordId]",
  kind: "detail",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/payments/[recordId]/page.tsx",
});
...
export default async function BillingPaymentDetailPage({
  ...
  const record = await getBusinessRecord(params.partnerId, "billing-payments", params.recordId);
  if (!record) notFound();
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href={`/partner/${params.partnerId}/billing/payments`} className="btn-outline">
                  &larr; Back
                </Link>
                <Link href={`/partner/${params.partnerId}/billing/payments/${params.recordId}/edit`} className="btn-outline">
                  Edit
                </Link>
