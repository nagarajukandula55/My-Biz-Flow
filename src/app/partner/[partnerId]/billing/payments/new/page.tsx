...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/payments/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/payments/new/page.tsx",
});

export default async function NewBillingPaymentPage({ params }: { params: { partnerId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "billing-payments")}
          />
        </div>
      </div>
    </AppShell>
