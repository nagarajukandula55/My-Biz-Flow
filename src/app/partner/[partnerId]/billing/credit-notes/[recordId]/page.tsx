...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/credit-notes/[recordId]",
  kind: "detail",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/credit-notes/[recordId]/page.tsx",
});
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href={`/partner/${params.partnerId}/billing/credit-notes`} className="btn-outline">
                  &larr; Back
                </Link>
                <Link href={`/partner/${params.partnerId}/billing/credit-notes/${params.recordId}/document`} className="btn-outline">
                  View document
                </Link>
                <Link href={`/partner/${params.partnerId}/billing/credit-notes/${params.recordId}/edit`} className="btn-outline">
                  Edit
                </Link>
