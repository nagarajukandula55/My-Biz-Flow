...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/credit-notes/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/credit-notes/[recordId]/edit/page.tsx",
});

export default async function EditCreditNotePage({ params }: { params: { partnerId: string; recordId: string } }) {
