...
export function ContactsNewButton({ partnerId }: { partnerId: string }) {
  ...
  return (
    <>
      ...
      <RecordFormModal
        ...
        action={(values: Record<string, unknown>) => createBusinessRecordAction(partnerId, "billing-contacts", values, "billing/contacts")}
      />
    </>
  );
}
