...
registerPage({
  ...
  path: "/partner/[partnerId]/billing/contacts/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/billing/contacts/[recordId]/edit/page.tsx",
});

export default async function EditBillingContactPage({ params }: { params: { partnerId: string; recordId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={updateBusinessRecordAction.bind(null, params.partnerId, "billing-contacts", params.recordId)}
          />
        </div>
      </div>
    </AppShell>
