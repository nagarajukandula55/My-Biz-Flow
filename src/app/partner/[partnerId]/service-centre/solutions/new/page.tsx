...
registerPage({
  ...
  path: "/partner/[partnerId]/service-centre/solutions/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/service-centre/solutions/new/page.tsx",
});

export default async function NewSolutionPage({ params }: { params: { partnerId: string } }) {
