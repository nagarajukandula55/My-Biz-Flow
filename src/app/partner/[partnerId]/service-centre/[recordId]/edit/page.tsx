...
registerPage({
  ...
  path: "/partner/[partnerId]/service-centre/[recordId]/edit",
  kind: "form",
...
export default async function EditServiceCentrePage({ params }: { params: { partnerId: string; recordId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={updateBusinessRecordAction.bind(null, params.partnerId, "service-centre", params.recordId)}
          />
        </div>
      </div>
    </AppShell>
