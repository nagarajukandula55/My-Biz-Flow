...
registerPage({
  ...
  path: "/partner/[partnerId]/service-centre/brands/[recordId]",
  kind: "detail",
  ...
  sourceFile: "src/app/partner/[partnerId]/service-centre/brands/[recordId]/page.tsx",
});
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href={`/partner/${params.partnerId}/service-centre/brands`} className="btn-outline">
                  &larr; Back
                </Link>
                <Link
                  href={`/partner/${params.partnerId}/service-centre/brands/${params.recordId}/edit`}
