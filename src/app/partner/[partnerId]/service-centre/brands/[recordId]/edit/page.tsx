...
registerPage({
  ...
  path: "/partner/[partnerId]/service-centre/brands/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/service-centre/brands/[recordId]/edit/page.tsx",
});

export default async function EditScBrandPage({ params }: { params: { partnerId: string; recordId: string } }) {
  const record = await getBusinessRecord(params.partnerId, "service-centre-brands", params.recordId);
  if (!record) notFound();
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={updateBusinessRecordAction.bind(null, params.partnerId, "service-centre-brands", params.recordId)}
          />
        </div>
      </div>
    </AppShell>
