...
registerPage({
  id: "service-centre.staff-change-password",
  moduleSlug: "service-centre",
  title: "Service Centre — Staff Change Password",
  path: "/partner/[partnerId]/service-centre/staff-change-password",
  kind: "form",
  superAdminOnly: false,
  customizableRegions: [],
  explanation:
    "Forced first-login password change for a PartnerStaff account — every staff account is created with mustChangePassword=true (the owner never sets one directly; one is generated and shown once). Requires an active staff session cookie.",
  sourceFile: "src/app/partner/[partnerId]/service-centre/staff-change-password/page.tsx",
});
...
export default async function StaffChangePasswordPage({
  ...
  if (!claims || claims.partnerId !== params.partnerId) redirect(`/partner/${params.partnerId}/service-centre/staff-login`);

  const action = changeStaffPasswordAction.bind(null, params.partnerId);
