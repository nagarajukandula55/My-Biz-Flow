      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={(values: Record<string, unknown>) => updateBusinessRecordAction(params.partnerId, "service-centre-customers", params.recordId, values, "service-centre/customers")}
          />
        </div>
      </div>
    </AppShell>
