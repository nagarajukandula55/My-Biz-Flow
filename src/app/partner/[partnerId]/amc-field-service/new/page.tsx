...
registerPage({
  ...
  path: "/partner/[partnerId]/amc-field-service/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/amc-field-service/new/page.tsx",
});

export default async function NewAmcFieldServicePage({ params }: { params: { partnerId: string } }) {
