...
registerPage({
  ...
  path: "/partner/[partnerId]/accounting-gst/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/accounting-gst/new/page.tsx",
});

export default async function NewAccountingGstPage({ params }: { params: { partnerId: string } }) {
