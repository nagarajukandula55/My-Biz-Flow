...
registerPage({
  ...
  path: "/partner/[partnerId]/accounting-gst/[recordId]",
  kind: "detail",
  ...
  sourceFile: "src/app/partner/[partnerId]/accounting-gst/[recordId]/page.tsx",
});
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href={`/partner/${params.partnerId}/accounting-gst`} className="btn-outline">
                  &larr; Back
                </Link>
                <Link
                  href={`/partner/${params.partnerId}/accounting-gst/${params.recordId}/edit`}
                  className="btn-outline"
                >
                  Edit
                </Link>
                <DeleteBusinessRecordButton partnerId={params.partnerId} moduleSlug="accounting-gst" recordKey={params.recordId} recordLabel={recordLabel} />
              </div>
            </div>
          }
        />
