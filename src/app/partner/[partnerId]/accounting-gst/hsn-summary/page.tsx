...
registerPage({
  ...
  path: "/partner/[partnerId]/accounting-gst/hsn-summary",
  kind: "dashboard",
  ...
  sourceFile: "src/app/partner/[partnerId]/accounting-gst/hsn-summary/page.tsx",
});
...
export default async function HsnSummaryPage({ params }: { params: { partnerId: string } }) {
