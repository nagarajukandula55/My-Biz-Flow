...
registerPage({
  ...
  path: "/partner/[partnerId]/accounting-gst/generate",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/accounting-gst/generate/page.tsx",
});
...
export default async function GenerateGstReturnPage({
  ...
  const [invoices, itcEntries, partner] = await Promise.all([
      ...
      <div>
        ...
        <div className="mt-6 max-w-2xl">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "accounting-gst")}
          />
        </div>
      </div>
    </AppShell>
