...
registerPage({
  ...
  path: "/partner/[partnerId]/accounting-gst/itc/[recordId]",
  kind: "detail",
  ...
  sourceFile: "src/app/partner/[partnerId]/accounting-gst/itc/[recordId]/page.tsx",
});
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href={`/partner/${params.partnerId}/accounting-gst/itc`} className="btn-outline">
                  &larr; Back
                </Link>
                <Link href={`/partner/${params.partnerId}/accounting-gst/itc/${params.recordId}/edit`} className="btn-outline">
                  Edit
                </Link>
