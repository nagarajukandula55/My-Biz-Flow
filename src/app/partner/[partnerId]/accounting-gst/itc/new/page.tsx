...
registerPage({
  ...
  path: "/partner/[partnerId]/accounting-gst/itc/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/accounting-gst/itc/new/page.tsx",
});
  ...
  return (
    <AppShell topbarTitle="New ITC Entry — GST">
      <div>
        ...
        <p className="mt-1 text-xs text-text-muted">Record an Input Tax Credit entry from a partner bill.</p>
        <div className="mt-6">
          <RecordForm
            fields={fields}
