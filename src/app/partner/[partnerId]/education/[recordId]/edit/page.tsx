...
registerPage({
  ...
  path: "/partner/[partnerId]/education/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/education/[recordId]/edit/page.tsx",
});

export default async function EditEducationPage({ params }: { params: { partnerId: string; recordId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={updateBusinessRecordAction.bind(null, params.partnerId, "education", params.recordId)}
          />
        </div>
      </div>
    </AppShell>
