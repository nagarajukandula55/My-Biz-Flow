...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/bom/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/bom/[recordId]/edit/page.tsx",
});

export default async function EditBomPage({ params }: { params: { partnerId: string; recordId: string } }) {
