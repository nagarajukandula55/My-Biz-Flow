...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/stock-adjustments/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/stock-adjustments/new/page.tsx",
});

export default async function NewStockAdjustmentsPage({ params }: { params: { partnerId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "inventory-stock-adjustments")}
          />
        </div>
      </div>
    </AppShell>
