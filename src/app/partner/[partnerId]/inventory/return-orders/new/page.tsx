...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/return-orders/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/return-orders/new/page.tsx",
});

export default async function NewReturnOrdersPage({ params }: { params: { partnerId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "inventory-return-orders")}
          />
        </div>
      </div>
    </AppShell>
