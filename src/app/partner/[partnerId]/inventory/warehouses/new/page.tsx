...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/warehouses/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/warehouses/new/page.tsx",
});

export default async function NewWarehousesPage({ params }: { params: { partnerId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "inventory-warehouses")}
          />
        </div>
      </div>
    </AppShell>
