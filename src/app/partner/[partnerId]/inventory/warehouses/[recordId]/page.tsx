...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/warehouses/[recordId]",
  kind: "detail",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/warehouses/[recordId]/page.tsx",
});
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href={`/partner/${params.partnerId}/inventory/warehouses`} className="btn-outline">
                  &larr; Back
                </Link>
                <Link href={`/partner/${params.partnerId}/inventory/warehouses/${params.recordId}/edit`} className="btn-outline">
                  Edit
                </Link>
              </div>
            </div>
