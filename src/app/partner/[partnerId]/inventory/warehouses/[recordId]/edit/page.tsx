...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/warehouses/[recordId]/edit",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/warehouses/[recordId]/edit/page.tsx",
});

export default async function EditWarehousesPage({ params }: { params: { partnerId: string; recordId: string } }) {
  const record = await getBusinessRecord(params.partnerId, "inventory-warehouses", params.recordId);
  if (!record) notFound();
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={updateBusinessRecordAction.bind(null, params.partnerId, "inventory-warehouses", params.recordId)}
          />
        </div>
      </div>
    </AppShell>
