...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/stock/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/stock/new/page.tsx",
});

export default async function NewStockPage({ params }: { params: { partnerId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "inventory-stock")}
          />
        </div>
      </div>
    </AppShell>
