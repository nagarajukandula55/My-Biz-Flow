...
registerPage({
  ...
  path: "/partner/[partnerId]/inventory/part-orders/new",
  kind: "form",
  ...
  sourceFile: "src/app/partner/[partnerId]/inventory/part-orders/new/page.tsx",
});

export default async function NewPartOrdersPage({ params }: { params: { partnerId: string } }) {
      ...
      <div>
        ...
        <div className="mt-6">
          <RecordForm
            ...
            action={createBusinessRecordAction.bind(null, params.partnerId, "inventory-part-orders")}
          />
        </div>
      </div>
    </AppShell>
