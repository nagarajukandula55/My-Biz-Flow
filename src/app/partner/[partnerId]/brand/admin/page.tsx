...
registerPage({
  ...
  moduleSlug: "brand",
  title: "Brand — Admin",
  path: "/partner/[partnerId]/brand/admin",
  kind: "admin",
  superAdminOnly: true,
  customizableRegions: [
  ...
  sourceFile: "src/app/partner/[partnerId]/brand/admin/page.tsx",
});

export default async function BrandAdminPage({ params }: { params: { partnerId: string } }) {
