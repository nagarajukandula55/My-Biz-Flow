...
export default async function EditClinicPage({ params }: { params: { recordId: string } }) {
  ...
  return (
    <AppShell navGroups={await buildVendorNavGroups("clinic")} topbarTitle={`Edit Appointment — ${mod?.label ?? "Clinic"}`}>
      <div>
