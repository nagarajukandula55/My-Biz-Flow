...
import { getReturnOrderRecord, getReturnOrderDetailFields, getReturnOrderTimeline, returnOrderRelated, returnOrderColumns } from "@/lib/sample-data/warehouse";
...
export default async function ReturnOrdersDetailPage({
  ...
  const record = getReturnOrderRecord(params.recordId);
