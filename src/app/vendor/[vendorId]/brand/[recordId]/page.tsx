...
export default async function BrandDetailPage({
  ...
  return (
    <AppShell vendorId={params.vendorId} navGroups={await buildVendorAdminNavGroups(undefined, "brand")} topbarTitle={mod?.label ?? "Brand"}>
      <div>
        <Link
          ...
          headerSlot={
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-text-muted">Location detail</p>
              </div>
