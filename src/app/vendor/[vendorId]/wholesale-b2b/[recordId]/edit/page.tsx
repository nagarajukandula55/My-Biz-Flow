...
export default async function EditWholesaleB2bPage({ params }: { params: { recordId: string } }) {
  ...
  return (
    <AppShell navGroups={await buildVendorNavGroups("wholesale-b2b")} topbarTitle={`Edit Order — ${mod?.label ?? "Wholesale / Distributor B2B"}`}>
      <div>
